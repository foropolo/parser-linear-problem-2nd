...
def dual_problem(MinMax,E,A,B,X):
    ...
    text_dual_problem_complete=text_for_objective_function+"\n"
    for x in range(len(E)):
        text_dual_problem_complete=text_dual_problem_complete+duality_A[x]+"\n"
    
    text_dual_problem_complete=text_dual_problem_complete+text_for_variables
    #print(text_dual_problem_complete)

    return text_dual_problem_complete
